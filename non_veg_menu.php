...
<body>
    <nav class="navbar navbar-expand-md bg-dark navbar-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <form method="post">
                        <input style="width:100%;font-size:20px;" class="btn btn-danger" type="submit" value="Main Menu" name="main_menu_button">
                    </form>
                </li>
                &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
                <li class="nav-item">
    ...
    <div class="container-fluid">
        ...
        <div class="container-fluid">
            <h2 style="color:white;"><i>Non-Veg >>> </i></h2>
            <?php
            echo "<div class='row'>";
